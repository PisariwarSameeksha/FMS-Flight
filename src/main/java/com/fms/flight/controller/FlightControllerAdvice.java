...
public class FlightControllerAdvice {
	...
	public String handleCustomerExceptions(FlightNumberNotFoundException e) {
		return e.getMessage();
	}
	
	@ExceptionHandler(FlightModelAlreadyexistsException.class)
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public String handleCustomerExceptions(FlightModelAlreadyexistsException e) {
		return e.getMessage();
	}
